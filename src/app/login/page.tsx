...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-stretch justify-end bg-app-gradient">
        <div className="flex w-full items-center justify-center p-4 md:w-1/2 md:max-w-md md:justify-end">
            <Dialog>
                <motion.div
