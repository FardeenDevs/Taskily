...
interface NotesBackupCodesDialogProps {
  open: boolean;
...
export function NotesBackupCodesDialog({ open, onOpenChange, codes }: NotesBackupCodesDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md" showCloseButton={false} onInteractOutside={(e) => e.preventDefault()}>
        <DialogHeader>
          <DialogTitle>Save Your Notes Backup Codes</DialogTitle>
          <DialogDescription>
            These codes are for the notes in this specific listspace. If you forget your notes password, you can use one of these codes to regain access. <span className="text-destructive font-semibold">Each code can only be used once.</span>
          </DialogDescription>
        </DialogHeader>
